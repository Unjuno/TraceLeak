#!/usr/bin/env python3
"""Validate an OpenSSL model-sequence sample materialization output contract."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Validate a model-sequence sample materialization output contract."
    )
...
def main() -> int:
    ...
    try:
        ...
        print(f"invalid model-sequence sample materialization output contract: {exc}")
        return 1
    print("valid model-sequence sample materialization output contract")
    return 0
