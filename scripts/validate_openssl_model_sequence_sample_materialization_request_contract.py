#!/usr/bin/env python3
"""Validate an OpenSSL model-sequence sample materialization request contract."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Validate a model-sequence sample materialization request contract."
    )
...
def main() -> int:
    ...
    try:
        ...
        print(f"invalid model-sequence sample materialization request contract: {exc}")
        return 1
    print("valid model-sequence sample materialization request contract")
    return 0
