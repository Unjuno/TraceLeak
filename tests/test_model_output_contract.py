from traceleak.model_output_contract import (
    MODEL_OUTPUT_FORMAT,
    ModelOutputRecord,
    model_output_record,
    model_output_record_from_dict,
)
...
def test_model_output_record_from_dict_round_trips() -> None:
    record = model_output_record(
        sample_id="sample_000001",
        model_id="model_000001",
        consumer_mode="sequence",
    ...
    parsed = model_output_record_from_dict(record)
    assert isinstance(parsed, ModelOutputRecord)
